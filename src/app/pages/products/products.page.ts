...
export class ProductsPage implements OnInit {
  ...
  constructor(private http:Http, private merchantScript: MerchantScript, private router: Router) { 
  ...
  async ngOnInit() {
    ...
    if (navigation && navigation.extras && navigation.extras.state) {
      ...
      this.merchantScript.indexedProducts = navigation.extras.state['indexedProducts'];
